...
const
    ...
    { getRuleOptionsSchema, validate } = require("eslint/lib/shared/config-validator"),
    { Linter, SourceCodeFixer, interpolate } = require("eslint/lib/linter");

const ajv = require("eslint/lib/shared/ajv")({ strictDefaults: true });
