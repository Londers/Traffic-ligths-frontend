...
const
    util = require("util"),
    configSchema = require("eslint/conf/config-schema"),
    ...
    { emitDeprecationWarning } = require("eslint/lib/shared/deprecation-warnings");

const ajv = require("eslint/lib/shared/ajv")();
