...
const { CLIEngine, getCLIEngineInternalSlots } = require("eslint/lib/cli-engine/cli-engine");
const BuiltinRules = require("eslint/lib/rules");
const { getRuleSeverity } = require("eslint/lib/shared/config-ops");
...
/** @typedef {import("eslint/lib/cli-engine/cli-engine").LintReport} CLIEngineLintReport */
