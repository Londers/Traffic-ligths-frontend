...
const
    ...
    BuiltInEnvironments = require("eslint/conf/environments"),
    pkg = require("eslint/package.json"),
    astUtils = require("eslint/lib/shared/ast-utils"),
    ConfigOps = require("eslint/lib/shared/config-ops"),
    validator = require("eslint/lib/shared/config-validator"),
    Traverser = require("eslint/lib/shared/traverser"),
    { SourceCode } = require("eslint/lib/source-code"),
    CodePathAnalyzer = require("eslint/lib/linter/code-path-analysis/code-path-analyzer"),
    applyDisableDirectives = require("eslint/lib/linter/apply-disable-directives"),
    ConfigCommentParser = require("eslint/lib/linter/config-comment-parser"),
    NodeEventGenerator = require("eslint/lib/linter/node-event-generator"),
    createReportTranslator = require("eslint/lib/linter/report-translator"),
    Rules = require("eslint/lib/linter/rules"),
    createEmitter = require("eslint/lib/linter/safe-emitter"),
    SourceCodeFixer = require("eslint/lib/linter/source-code-fixer"),
    timing = require("eslint/lib/linter/timing"),
    ruleReplacements = require("eslint/conf/replacements.json");
...
/** @typedef {InstanceType<import("eslint/lib/cli-engine/config-array")["ConfigArray"]>} ConfigArray */
/** @typedef {InstanceType<import("eslint/lib/cli-engine/config-array")["ExtractedConfig"]>} ExtractedConfig */
/** @typedef {import("eslint/lib/shared/types").ConfigData} ConfigData */
/** @typedef {import("eslint/lib/shared/types").Environment} Environment */
/** @typedef {import("eslint/lib/shared/types").GlobalConf} GlobalConf */
/** @typedef {import("eslint/lib/shared/types").LintMessage} LintMessage */
/** @typedef {import("eslint/lib/shared/types").ParserOptions} ParserOptions */
/** @typedef {import("eslint/lib/shared/types").Processor} Processor */
/** @typedef {import("eslint/lib/shared/types").Rule} Rule */
