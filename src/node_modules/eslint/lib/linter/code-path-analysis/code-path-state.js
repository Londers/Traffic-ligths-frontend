...
const CodePathSegment = require("eslint/lib/linter/code-path-analysis/code-path-segment"),
    ForkContext = require("eslint/lib/linter/code-path-analysis/fork-context");
