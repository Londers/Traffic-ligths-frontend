...
const { validateConfigSchema } = require("eslint/lib/shared/config-validator");
...
const {
    ...
    IgnorePattern,
    OverrideTester
} = require("eslint/lib/cli-engine/config-array");
...
/** @typedef {import("eslint/lib/shared/types").OverrideConfigData} OverrideConfigData */
/** @typedef {import("eslint/lib/shared/types").Parser} Parser */
