...
const defaultOptions = require("eslint/conf/default-cli-options");
const pkg = require("eslint/package.json");
const ConfigOps = require("eslint/lib/shared/config-ops");
const naming = require("eslint/lib/shared/naming");
...
const { IgnorePattern, getUsedExtractedConfigs } = require("eslint/lib/cli-engine/config-array");
const { FileEnumerator } = require("eslint/lib/cli-engine/file-enumerator");
const hash = require("eslint/lib/cli-engine/hash");
const LintResultCache = require("eslint/lib/cli-engine/lint-result-cache");
...
/** @typedef {import("eslint/lib/shared/types").DeprecatedRuleInfo} DeprecatedRuleInfo */
